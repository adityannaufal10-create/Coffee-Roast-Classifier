...
- NumPy
- Hugging Face Spaces
- seluruh pihak yang mendukung pengembangan proyek ini
...
- lebih panjang,
- lebih informatif,
- dan cocok untuk kebutuhan dokumentasi GitHub maupun portfolio.

Silakan sesuaikan bagian-bagian seperti:
- nama author,
- link demo,
- hasil evaluasi model,
- dataset,
- dan detail training
sesuai kondisi repository sebenarnya.
